...
對 ADSP 來說，aliasing 不是只在 A/D 發生。DFT [[Frequency sampling FIR design|frequency sampling]]、downsampling、chroma subsampling、[[Fast Fourier transform|FFT]] circular [[Convolution|convolution]] 都有類似「週期化後重疊」的影子。看到 fold、periodic spectrum、circular convolution 時都該想到這個概念。
